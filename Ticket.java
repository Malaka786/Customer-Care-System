...
public class Ticket {
    ...
    @Pattern(regexp = "Technical|Billing|General|Account|Other", message = "Invalid category")
    ...
    public void setResponses(List<AgentResponse> responses) { this.responses = responses; }
